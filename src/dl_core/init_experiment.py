...
6. Move on to `uv run dl-sweep experiments/lr_sweep.yaml` once a
   single run works.
...
def main(argv: list[str] | None = None) -> int:
    ...
    print("  3. Adjust `configs/base.yaml` for your dataset and optional naming.")
    print("  4. Start with `uv run dl-run --config configs/base.yaml`.")
    print("  5. Then try `uv run dl-sweep experiments/lr_sweep.yaml`.")
    return 0

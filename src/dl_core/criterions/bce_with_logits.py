...
class BCEWithLogits(BaseCriterion):
    ...
    CONFIG_FIELDS = [
        config_field(
            ...
            "Optional element-wise weight passed to BCEWithLogitsLoss.",
            default=None,
        ),
        config_field(
            "pos_weight",
            "float | list[float] | None",
            "Optional positive-class weighting for imbalanced data.",
            default=None,
        ),
        config_field(
            "reduction",
            "str",
            "Loss reduction mode used by BCEWithLogitsLoss.",
            default="mean",
        ),
    ]

...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            "  dl-inspect-dataset  Summarize split sizes and one batch preview.\n"
            "  dl-sync             Download tracked remote artifacts locally.\n"
            "  dl-run              Run one config locally.\n"
            "  dl-smoke            Check one dataset batch and one model forward.\n"
            "  dl-sweep            Expand and execute a sweep config.\n"
            "  dl-analyze          Inspect saved sweep results.\n"
            "  dl-migrate          Reserved for future repository migrations.\n"
    ...
    add_parser = subparsers.add_parser(
        ...
        epilog=(
            ...
            "  dl-core add optimizer MyOptimizer\n"
            "  dl-core add optimizer MyAdamw --base adamw\n"
            "  dl-core add sampler MySampler\n"
            "  dl-core add scheduler MyScheduler\n"
            "  dl-core add scheduler MyCosine --base cosine\n"
